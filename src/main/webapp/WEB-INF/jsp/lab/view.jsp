	...
	<div class="container">
		<div class="row entry">
			...
			<div class="col-lg-8">	
	            ...
	            <div class="lab-icons">
					<div ng-if="entry.liveURL" class="icon">
						<a ng-href="{{entry.liveURL}}"><em>Live</em> <img src="<c:url value="/resources/images/globe-icon.png"/>"></a>
					</div>
					<div ng-if="entry.repoURL" class="icon">
						<a ng-href="{{entry.repoURL}}"><em>Source</em> <img src="<c:url value="/resources/images/footer/github-footer.png"/>"></a>
					</div>
				</div>
				<hr>
            </div>
